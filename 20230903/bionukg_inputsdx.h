...
namespace bionukg {
    ...
    public:
        ...
        mouse_d()
		{
            ...
            hr = mouse->SetCooperativeLevel(GetConsoleWindow(), DISCL_BACKGROUND | DISCL_NONEXCLUSIVE);
    ...
    public:
        ...
        keyboard_d()
        {
            ...
            // Set the cooperative level
            hr = keyboard->SetCooperativeLevel(GetConsoleWindow(), DISCL_BACKGROUND | DISCL_NONEXCLUSIVE);
